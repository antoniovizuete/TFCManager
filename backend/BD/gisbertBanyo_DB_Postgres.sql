...
('Admin', 'admin@gmail.com', '$2a$10$FlRlpGFCpp.1.0OiPn3PMuSI.ULF7KafuL5Ny7GiRjRViaj8rhun6', 'Calle Inventada Nº 12 3ºIzq', 'Alcantarilla', 'Murcia', '30820', '626235121', 1),
...
CREATE TABLE customers (
    ...
    customer_state BOOLEAN DEFAULT TRUE
);
...
('32154785G', 'Gabriel García Márquez',    'gabrielgarciamarquez@gmail.com', 'Ruta de los Molinos 49 4A',  'Campo de Criptana', 'Ciudad Real', '13610',  '673198654', 'Pagos pendientes');
 ...
 CREATE TABLE projects(
    ...
    project_author INTEGER DEFAULT NULL,
    project_customer INTEGER DEFAULT NULL,
...
CREATE TABLE materials(
    ...
    material_state BOOLEAN DEFAULT TRUE
);
...
CREATE TABLE hourlyrates(
    hourlyrate_id SERIAL PRIMARY KEY,
    hourlyrate_name VARCHAR (20),
    hourlyrate_pvp DECIMAL (6,2),
    hourlyrate_state BOOLEAN DEFAULT TRUE
);
...
CREATE TABLE workorders(
    ...
    workorder_author INTEGER DEFAULT NULL,
    workorder_project INTEGER DEFAULT NULL,
    workorder_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    workorder_hours INTEGER,
    workorder_minutes INTEGER,
    workorder_hourlyrate INTEGER DEFAULT NULL,
    workorder_alert VARCHAR (1000),
    workorder_state BOOLEAN DEFAULT TRUE,
...
CREATE TABLE workorder_materials(
    workorderMaterials_id SERIAL PRIMARY KEY,
    workorder_id INTEGER DEFAULT NULL,
